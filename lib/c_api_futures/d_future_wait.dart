...
var f3 = Future.delayed(Duration(seconds: 3), () => 'F3'); // essa função demora mais que as outras, mas o wait espera a conclusão dela para apresentar todos os resultados de uma ves

var f4 = Future.delayed(Duration(seconds: 1), () => 'F4');

var f5 = Future.delayed(Duration(seconds: 1), () => Future.error('Erro em alguma coisa')); // como está função está com erro se colocarmos ela dentro do wait todas iram apresentar erro
...
Future.wait([f1, f2, f3, f4, f5 ]).then((value) {
print(DateTime.now().toIso8601String());
